...
function option2(){
      ...
      try{
            ...
            $("#option2").click(function(){
                  ...
                  var valor = "Aprendizaje";
                  var descaript="Es el proceso a través del cual se adquieren nuevas habilidades, destrezas, conocimientos, conductas o valores como resultado del estudio, la experiencia, la instrucción, el razonamiento y la observación. Este proceso puede ser analizado desde distintas perspectivas, por lo que existen distintas teorías del aprendizaje."
...
function option3(){
      ...
      try{
            ...
            $("#option3").click(function(){
                  ...
                  var valor = "Asertividad";
                  var descaript="Saber analizar las metas de trabajo y los pasos necesarios para conseguirlas asertivo es saber adónde vamos. Además, implica una conciencia del talento propio y del de los demás para saber ponerlos al servicio de los procesos que tengan lugar en la empresa."
...
function option4(){
      ...
      try{
            ...
            $("#option4").click(function(){
                  ...
                  var valor = "Autocritica";
                  var descaript="Tener la capacidad de analizar, cada cierto tiempo, las actividades y resultados de la empresa es una manera de evaluar cuáles son las fortalezas y debilidades que tiene la institución y, por ende, los trabajadores. Esto forma parte de saber asumir los aciertos y errores cometidos"
...
function option5(){
      ...
      try{
            ...
            $("#option5").click(function(){
                  ...
                  var valor = "Calidad de servicio";
                  var descaript="Es un concepto que deriva de la propia definición de Calidad, entendida como satisfacción"+
                  " de las necesidades y expectativas del cliente presentando productos y servicios de óptima"+
                  "calidad"
...
function option6(){
      ...
      try{
            ...
            $("#option6").click(function(){
                  ...
                  var valor = "Calidad de vida";
                  var descaript="Designa las condiciones en que vive una persona que hacen que su existencia sea placentera"+
                  "y digna de ser vivida, o la llenen de aflicción. Es un concepto extremadamente subjetivo y"+
                  "muy vinculado a la sociedad en que el individuo existe y se desarrolla."
...
function option9(){
      ...
      try{
       ...
       $("#option9").css({"background-color":"#FC7323", "border-radius":"50px", "color":"white","width": "95%"})
                  ...
                  var descaript="A través de la constancia y la perseverancia se alcanzan objetivos. Ser constante significa"+
                  " trabajar y luchar por un logro, superar pruebas y no dejarse vencer por los errores o"+
                  " adversidades."
      ...
      try{
            ...
            $("#option10").click(function(){
                  $("#option10").css({"background-color":"#FC7323", "border-radius":"50px", "color":"white","width": "95%"})
                        ...
                        var descaript="Se entiende a la facultad que alguien tiene para crear y a la capacidad creativa de un"+
...
function option11(){
      ...
      try{
            ...
            $("#option11").click(function(){
                  ...
                  var valor = "Crecimiento personal";
                  var descaript="El camino hacia el bienestar y el crecimiento personal implica lograr el equilibrio y la"+
                  " armonía en nuestro día a día, en la relación con nosotros mismos y con los demás. Por eso,"+
                  " es necesario observar e identificar si estamos en el lugar donde queremos estar y si estamos"+
                  " satisfechos con nuestra vida, y definir qué podemos hacer para mejorar lo que no nos hace"+
                  " satisface, así es posible trabajar para que ese cambio sea posible."
...
function option12(){
      ...
      try{
            ...
            $("#option12").click(function(){
                  ...
                  var descaript="La disciplina de las personas se refleja en los resultados de su trabajo. Ser disciplinado se"+
                  " relaciona con la puntualidad, seguir las normas, ser proactivo, proponerse alcanzar"+
                  " objetivos y ser exigente. Por medio de la disciplina también se logran las metas."
      ...
      try{
            ...
            $("#optiona2").click(function(){
                  $("#optiona2").css({"background-color":"#FC7323", "border-radius":"50px", "color":"white","width": "95%"})
                              ...
                              var valor = "Disponibilidad al cambio";
                              var descaript="Llevar a cabo las ideas de negocios requiere de mucho temple, y sobre todo tener por"+
                              " entendido que habrá la necesidad siempre de estar dispuesto al cambio, cuando las cosas no"+
                              " salen como se planean se requiere de pequeños o grandes ajustes que harán que nuestro"+
                              " camino tome un nuevo rumbo; habrá que estar con la disponibilidad y la capacidad de "+
                              " entender que las cosas no siempre salen como las previmos."
      ...
      try{
            ...
            $("#optiona3").click(function(){
                  $("#optiona3").css({"background-color":"#FC7323", "border-radius":"50px", "color":"white","width": "95%"})
                              ...
                              var valor = "Eficiencia";
                              var descaript="Es la relación que existe entre los recursos empleados en una empresa y los resultados"+
                              ...
                              " el mismo número de recursos o menos. La eficiencia es muy importante en las empresas, ya "+
      ...
      try{
            ...
            $("#optiona4").click(function(){
                  $("#optiona4").css({"background-color":"#FC7323", "border-radius":"50px", "color":"white","width": "95%"})
                              ...
                              var valor = "Empatía";
                              var descaript="Se define como una habilidad social, tanto cognitiva como emocional, que permite ponerse"+
                              " en la situación emocional de otra persona. Tener empatía es entender actitudes, acciones o"+
                              " sentimientos de otras personas, conectar con sus emociones y entender los deseos, miedos o"+
                              "enfados "
...
function optiona2_5(){
            ...
            try{
                  ...
                  $("#optiona5").click(function(){
                        ...
                        var descaript="Se entiende a la característica de flexible. Se trata de una palabra que permite resaltar la"+
                        " disposición de un individuo u objeto para ser doblado con facilidad, la condición de"+
                        " plegarse según la voluntad de otros y la susceptibilidad para adaptarse a los cambios de"+
...
function optiona2_6(){
      ...
      try{
            ...
            $("#optiona6").click(function(){
                  ...
                  var descaript="Es un valor o cualidad propio de los seres humanos que tiene una estrecha relación con los"+
                  " principios de verdad y justicia y con la integridad moral. Una persona honesta es aquella"+
                  " que procura siempre anteponer la verdad en sus pensamientos, expresiones y acciones."
...
function optiona2_7(){
      ...
      try{
            $("#optiona7").click(function(){
                  ...
                  var valor = "Humanismo";
                  var descaript="Es la manera mas adecuada de conducir una empresa. Las grandes compañías que logran"+
                  " alcanzar el éxito; deseado, son aquellas que plantean estrategias para el bienestar y el"+
                  " 	desarrollo de su personal para así alcanzar un desarrollo favorable y una estabilidad"
...
function optiona2_8(){
      ...
      try{
            ...
            $("#optiona8").click(function(){
                  ...
                  var valor = "Iniciativa";
                  var descaript="Es la cualidad que poseen algunas personas de poder por sí mismos iniciar alguna cuestión,"+
                  " bien sea comenzar una actividad, o buscar soluciones a alguna problemática. Lo que se"+
                  " 	debe tener en cuenta con este término es que una de sus características principales es que la"+
                  " iniciativa nace de cada persona, es decir, no hay ningún factor externo que lo impulse para"+
                  " lograr su objetivo."
...
function optiona2_9(){
      ...
      try{
            ...
            $("#optiona9").click(function(){
                  ...
                  var valor = "Integridad";
                  var descaript="Ser íntegro se refiere a ser auténtico y honesto durante las relaciones laborales. Exponer"+
                  " una situación o caso tal cual como es, no hacer estafas ni falsas promesas a otras personas,"+
...
function optiona2_10(){
      ...
      try{
            ...
            $("#optiona10").click(function(){
                  ...
                  var valor = "Justicia";
                  var descaript="Es un valor que inclina a obrar y juzgar, teniendo por guía la verdad y dando a cada uno lo"+
                  " que le pertenece, y lo que le pertenece a cada uno es su realización y su dignidad. La"+
                  " justicia como valor democrático es un nivel que se desea alcanzar y está vinculado"+
                  "estrictamente al valor"
...
function optiona2_11(){
      ...
      try{
            ...
            $("#optiona11").click(function(){
                  ...
                  var valor = "Liderazgo";
                  var descaript="Es la habilidad de un individuo de influenciar, motivar e inspirar a que otros contribuyan a"+
                  " la efectividad y al éxito de las organizaciones de las que son miembros. ... Un líder es capaz"+
                  " de constituir reglas para orientar y conducir a otros a la concreción de los objetivos"+
                  " establecidos"
...
function optiona2_12(){
      ...
      try{
            ...
            $("#optiona12").click(function(){
                  ...
                  var descaript="La perseverancia en un empresario significa logros, quien esté dispuesto a tener negocios productivos, necesariamente requiere de levantarse y luchar todos los días en contra de las"+
                  ...
                  " factores que pueden inundar la mente del empresario todos los días, habrá que luchar incesantemente contra estos pensamientos para no dejarse vencer."
...
function optiona2_13(){
      ...
      try{
            ...
            $("#optiona13").click(function(){
                  ...
                  var valor = "Pertenencia";
                  var descaript="En la organización. ... Por el contrario, si un trabajador está convencido que la compañía es"+
                  " buena y que le da beneficios es una persona que realmente luchará en pro de las metas de la"+
                  " empresa y lo que necesitan las organizaciones es que su fuerza laboral esté unida y trabaje"+
                  " en equipo"
...
function optiona3_1(){
      ...
      try{
            ...
            $("#option3_1").click(function(){
                  ...
                  var descaript="Tomar acción sobre las oportunidades que se nos presentan a diario; prever, intuir, y actuar"+
                  " de manera positiva sobre todos los problemas que puedan ocurrir en el negocio, uno debe"+
                  " ser capaz de reaccionar instantáneamente y de forma eficaz, en todas o en casi todas las"+
...
function optiona3_2(){
      ...
      try{
            ...
            $("#option3_2").click(function(){
                  ...
                  var valor = "Profesionalismo";
                  var descaript="Es la manera o la forma de desarrollar cierta actividad profesional con un total"+
                  " compromiso, mesura y responsabilidad, acorde a su formación específica y siguiendo las"+
                  " spautas preestablecidas socialmente."
