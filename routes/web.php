...
// })->name('index');
    ...
    })->name('terminos')->middleware('disablepreventback')->middleware('verified');
    ...
    Route::get('/Propuesta/paso1', function () {
        return view('Modulo1.Propuesta.vista3');
    })->name('Propuesta/paso1')->middleware('disablepreventback')->middleware('auth')->middleware('verified');
    Route::get('/Propuesta/paso2', function () {
        return view('Modulo1.Propuesta.vista4');
    })->name('Propuesta/paso2')->middleware('disablepreventback')->middleware('auth')->middleware('verified');
    Route::post('/mega','planeacionControlle@vista24')->name('mega')->middleware('disablepreventback')->middleware('verified');
    Route::get('/Propuesta/Editar', function () {
        return view('Modulo1.Propuesta.Editar');
    })->name('Propuesta/editar')->middleware('auth')->middleware('disablepreventback')->middleware('verified');
    Route::get('/Propuesta', function () {
        return view('Modulo1.Propuesta.vista8');
    })->name('Propuesta')->middleware('disablepreventback')->middleware('auth')->middleware('verified');
    Route::get('/Mision/paso1', function () {
        return view('Modulo1.Mision.vista9');
    })->name('Mision/paso1')->middleware('disablepreventback')->middleware('auth')->middleware('verified');
    Route::get('/Mision/paso2', function () {
        return view('Modulo1.Mision.vista10');
    })->name('Mision/paso2')->middleware('disablepreventback')->middleware('auth')->middleware('verified');
    Route::get('/mision/edit', function () {
        return view('Modulo1.Mision.vista13');
    })->name('mision/edit')->middleware('disablepreventback')->middleware('auth')->middleware('verified');
    Route::get('/Mision/list', function () {
        return view('Modulo1.Mision.vista14');
    })->name('Mision/list')->middleware('disablepreventback')->middleware('auth')->middleware('verified');
    Route::get('/Vision/paso1', function () {
        return view('Modulo1.Vision.vista15');
    })->name('Vision/paso1')->middleware('disablepreventback')->middleware('auth')->middleware('verified');
    Route::get('/Vision/paso2', function () {
        return view('Modulo1.Vision.vista16');
    })->name('Vision/paso2')->middleware('disablepreventback')->middleware('auth')->middleware('verified');
    Route::get('/Vision/edt', function () {
        return view('Modulo1.Vision.vista17');
    })->name('Vision/edt')->middleware('disablepreventback')->middleware('auth');
    Route::get('/Vision/list', function () {
        return view('Modulo1.Vision.vista18');
    })->name('tist')->middleware('disablepreventback')->middleware('auth');
    Route::get('/MEGA/paso1', function () {
        return view('Modulo1.MEGA.vista19');
    })->name('MEGA/paso1')->middleware('disablepreventback')->middleware('auth');
    Route::get('/MEGA/paso2', function () {
        return view('Modulo1.MEGA.vista20');
    })->name('MEGA/paso2')->middleware('disablepreventback')->middleware('auth');
    Route::get('/MEGA/paso3', function () {
        return view('Modulo1.MEGA.vista21');
    })->name('MEGA/paso3')->middleware('disablepreventback')->middleware('auth');
    Route::get('/MEGA/edt', function () {
        return view('Modulo1.MEGA.vista22');
    })->name('MEGA/edt')->middleware('disablepreventback')->middleware('auth');
    Route::get('/MEGA/list', function () {
        return view('Modulo1.MEGA.vista23');
    })->name('MEGA/list')->middleware('disablepreventback')->middleware('auth');
    Route::get('/Corporativos/paso1', function () {
        return view('Modulo1.Corporativos.vista24');
    })->name('Corporativos/paso1')->middleware('disablepreventback')->middleware('auth')->middleware('verified');
    Route::get('/Corporativos/paso1_1', function () {
        return view('Modulo1.Corporativos.vista24_1');
    })->name('Corporativos/paso1_1')->middleware('disablepreventback')->middleware('auth')->middleware('verified');
    Route::get('select/{id}','planeacionControlle@select')->name('select')->middleware('auth')->middleware('verified');
    Route::get('/Corporativos/paso2', function () {
        return view('Modulo1.Corporativos.vista28');
    })->name('Corporativos/paso2')->middleware('disablepreventback')->middleware('auth')->middleware('verified');
    Route::get('/Corporativos/paso3', function () {
        return view('Modulo1.Corporativos.vista29');
    })->name('Corporativos/paso3')->middleware('disablepreventback')->middleware('auth')->middleware('verified');
    ...
    //MODULO 2
    Route::get('/diagnosticoEstra', function () {
        return view('Modulo2.diagnosticoEstra');
    })->name('diagnosticoEstra')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/anaPestal', function () {
        return view('Modulo2.anaPestal');
    })->name('anaPestal')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/anaPorter', function () {
        return view('Modulo2.anaPorter');
    })->name('anaPorter')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/analisisPorter', function () {
        return view('Modulo2.anaPorter');
    })->name('analisisPorter');
    Route::get('/capacidadInterna', function () {
        return view('Modulo2.capacidadInterna');
    })->name('capacidadInterna')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/factoresInternosI', function () {
        return view('Modulo2.factoresInternosI');
    })->name('factoresInternosI')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/ansorftMercado', function () {
        return view('Modulo2.ansorftMercado');
    })->name('ansorftMercado')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/ansorftDesarrollo', function () {
        return view('Modulo2.ansorftDesarrollo');
    })->name('ansorftDesarrollo')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/ansorftDesarrolloMerca', function () {
        return view('Modulo2.ansorftDesarrolloMerca');
    })->name('ansorftDesarrolloMerca')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/ansorftDiversifica', function () {
        return view('Modulo2.ansorftDiversifica');
    })->name('ansorftDiversifica')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/factoresExternosI', function () {
        return view('Modulo2.factoresExternosI');
    })->name('factoresExternosI')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/factoresExternos', function () {
        return view('Modulo2.factoresExternos');
    })->name('factoresExternos')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/analisisEFInfo', function () {
        return view('Modulo2.analisisEFInfo');
    })->name('analisisEFInfo')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/analisisDofaInfo', function () {
        return view('Modulo2.analisisDofaInfo');
    })->name('analisisDofaInfo')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    ...
    Route::get('/Dofa2/{id}','DofaController@dofa2')->name('dofa2')
    ...
    })->name('tercero1-1')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/tercero1-2', function () {
        return view('Modulo3.formulacion_de_estrategias.tercero1-2');
    })->name('tercero1-2')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/tercero1-3', function () {
        return view('Modulo3.formulacion_de_estrategias.tercero1-3');
    })->name('tercero1-3')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/tercero2-4', function () {
        return view('Modulo3.tercero2-4');
    })->name('tercero2-4')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    ...
    Route::get('/vista1-1', function () {
        return view('Modulo4.vista1-1');
    })->name('vista1-1')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/vista1-2', function () {
        return view('Modulo4.vista1-2');
    })->name('vista1-2')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
    Route::get('/vista1-3', function () {
        return view('Modulo4.vista1-3');
    })->name('vista1-3')->middleware('disablepreventback')->middleware('verified')->middleware('auth');
