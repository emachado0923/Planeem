...
<!-- son las listas de estrategias que se llaman desde la dofa los targets de esos modales-->
  <div class="lista">
      <h4 style="line-height: 41px;">Estrategias Dofa<span value="mas_factores" onclick="mas_factores()" class="icon-circle-down" style=" margin-left: 8%;"></span></h4>
  </div>
  <section id="factores">
      <div id="factor">
      ...
      <div class="modal-body">
          <form action="#" method="post">
            ...
            <div class="card-footer">
                ...
                <button id="buttonEdit" type="button" class="btn btn-success float-right">Actualizar</button>
            </div>
          </form>
      </div>
    </div><!-- /.modal-content -->
