...
<form method="post" role="from" action="{{route('misEstrategias')}}">
    ...
    <div>
        ...
        <div id="campo_texto"  class="campo_texto">
            <h3 style="text-align: center;">Mis estrategias xD</h3>
            <!-- Estas son las estrategias que se van a iterar
...
<!-- son las listas de estrategias que se llaman desde la dofa-->
        <div class="lista">
