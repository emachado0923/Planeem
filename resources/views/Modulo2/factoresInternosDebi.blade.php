				...
				<div class="modal-content modal-modificado1">
					<div class="modal-body">
						<div id="cierra_caja5"><a data-dismiss="modal" aria-label="Close" style="background: white; outline: none !important; margin-left: 93%"><i class="icon-cancel-circle" style="color: #FC7323; font-size: 21px;margin-top: 2%; cursor: pointer;"></i></a> 
							Debilidades:
							<br><br> 
							<br>Son aquellos factores internos que generan una posición desfavorable frente a la competencia, 
							<br>por ejemplo, recursos y habilidades de las que carece o actividades que no se desarrollan de 
							<br>la mejor manera en la organización
						</div>
					</div>
				</div>
			</div>
